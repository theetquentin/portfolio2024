...
const Footer = () => {
  return (
    <section
      id="contact"
      className="menu border-t-2 border-zinc-300 dark:border-zinc-700 mt-10 py-4"
    >
      <div className="mx-auto px-8 max-w-3xl">
        <p className="text-base px-2 sm:text-lg">Me contacter ?</p>
        <div className="flex">
          <div className="flex flex-wrap items-center gap-1 sm:gap-2 w-2/4 ms-0">
            <a
              href="mailto:quentin.theet@gmail.com"
              target="_blank"
              className="p-2 rounded-full hover:bg-zinc-200/70 dark:hover:bg-zinc-800/70 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              className="group p-2 rounded-full flex items-center gap-2 text-lg sm:text-xl hover:bg-zinc-200/70 dark:hover:bg-zinc-800/70 transition-colors"
            >
