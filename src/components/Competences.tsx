  ...
  return (
    <section id="competences" className="mx-auto menu px-8 max-w-3xl">
      <div className="flex items-center gap-2">
        <IoBookOutline className="w-8 h-8 text-primary" />
      ...
      <div className="flex items-center gap-2 pt-4">
        <IoLanguageOutline className="w-6 h-6 text-primary" />
        <p className="text-lg font-light text-primary">Anglais niveau B2</p>
      </div>
    </section>
  );
};
